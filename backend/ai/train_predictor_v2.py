...
from ai.data.dataset_prediction_v2 import MSLesionPredictionV2Dataset
...
def train_predictor(
    ...
    dataset = MSLesionPredictionV2Dataset(msseg2_dir, augment=True)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if val_dice > best_dice:
            ...
            }, os.path.join(save_dir, "predictor_lesions_v2.pth"))
    ...
    plt.savefig("ai/plots/predictor_curves_v.png", dpi=150, bbox_inches='tight')
    plt.show()
